...
custohttpUpdate::custohttpUpdate(int httpClientTimeout)
...
HTTPUpdateResult custohttpUpdate::update(const String& url, const String& currentVersion,
...
// Added by Nuno to support user + pass http Authorization
HTTPUpdateResult custohttpUpdate::updateup(const String& url, const String& currentVersion,
        const String& httpuser, const String& httppass)
{
    HTTPClient http;
    http.begin(url);
...
HTTPUpdateResult custohttpUpdate::updateSpiffs(const String& url, const String& currentVersion,
        const String& httpsFingerprint)
{
    HTTPClient http;
    http.begin(url, httpsFingerprint);
...
// Added by Nuno to support user + pass http Authorization
HTTPUpdateResult custohttpUpdate::updateSpiffsup(const String& url, const String& currentVersion,
        const String& httpuser, const String& httppass)
{
    HTTPClient http;
    http.begin(url);
...
HTTPUpdateResult custohttpUpdate::update(const String& host, uint16_t port, const String& uri, const String& currentVersion,
...
HTTPUpdateResult custohttpUpdate::update(const String& host, uint16_t port, const String& uri,
...
HTTPUpdateResult custohttpUpdate::update(const String& host, uint16_t port, const String& url,
 ...
 */
int custohttpUpdate::getLastError(void)
{
    return _lastError;
}
 ...
 * @return String error
 */
String custohttpUpdate::getLastErrorString(void)
{
 ...
 */
HTTPUpdateResult custohttpUpdate::handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs)
{
 ...
 */
bool custohttpUpdate::runUpdate(Stream& in, uint32_t size, String md5, int command)
{
