...
class custohttpUpdate
{
public:
    custohttpUpdate(void);
    custohttpUpdate(int httpClientTimeout);
    ~custohttpUpdate(void);
    ...
    t_httpUpdate_return updateup(const String& url, const String& currentVersion,
	...
	// Added by Nuno to support user + pass http Authorization
    t_httpUpdate_return updateSpiffsup(const String& url, const String& currentVersion,
                               const String& httpuser, const String& httppass);
...
extern custohttpUpdate ESPhttpUpdate;
#endif
